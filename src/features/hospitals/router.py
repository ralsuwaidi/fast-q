...
from features.hospitals.queries.get_hospital import (
    GetHospitalByNameHandler,
    GetHospitalByNameQuery,
)
...
async def mgh_schedule(
    ...
    hospital = GetHospitalByNameHandler(db).execute(
        GetHospitalByNameQuery("Hospital A")
    )
...
async def mnh_schedule(
    ...
    hospital = GetHospitalByNameHandler(db).execute(
        GetHospitalByNameQuery("Hospital B")
    )
